...
/**
 * <p>Java class for landInfoByPersonParcelIdsData complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="landInfoByPersonParcelIdsData"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="paymentDataList" type="{http://property.xyp.gov.mn/}landValuationDetailData" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "landInfoByPersonParcelIdsData", propOrder = {
    "addressKhashaa",
    "addressStreetName",
    "aimagCityName",
    "appId",
...
public class LandInfoByPersonParcelIdsData {
    ...
    protected List<LandValuationDetailData> paymentDataList;
    ...
    /**
     * Gets the value of the paymentDataList property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the paymentDataList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPaymentDataList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link LandValuationDetailData }
     * 
     * 
     */
    public List<LandValuationDetailData> getPaymentDataList() {
        if (paymentDataList == null) {
            paymentDataList = new ArrayList<LandValuationDetailData>();
        }
