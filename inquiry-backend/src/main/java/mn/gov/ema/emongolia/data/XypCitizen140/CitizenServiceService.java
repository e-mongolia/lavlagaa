 ...
 * 
 */
@WebServiceClient(name = "CitizenServiceService", targetNamespace = "http://citizen.xyp.gov.mn/", wsdlLocation = "https://xyp.gov.mn/citizen-1.4.0/ws?WSDL")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://xyp.gov.mn/citizen-1.4.0/ws?WSDL");
